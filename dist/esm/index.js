...
function ParseString(str, useInnerHtml) {
    if (useInnerHtml) {
        str = HtmlEncode(str).replace(/ /g, '&nbsp;');
        return (React.createElement("div", { className: "content", dangerouslySetInnerHTML: { __html: str } }));
    }
    else {
        return str;
    }
...
var Table = /** @class */ (function (_super) {
    ...
    Table.prototype.cellClick = function (row, column) {
...
export { Column, ColumnGroup, HeaderGroup, Table };
